                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        icon: const Icon(Icons.warning_amber_rounded, color: Color(0xFF666666), size: 20),
                      ...
                      IconButton(
                        padding: EdgeInsets.zero,
                        constraints: const BoxConstraints(minWidth: 36, minHeight: 36),
                        icon: const Icon(Icons.map_outlined, color: Color(0xFF666666), size: 20),
                      ...
                      IconButton(
                        padding: EdgeInsets.zero,
                        constraints: const BoxConstraints(minWidth: 36, minHeight: 36),
                        icon: const Icon(Icons.help_outline, color: Color(0xFF666666), size: 20),
                        onPressed: _showHelp,
                      ),
                      IconButton(
                        padding: EdgeInsets.zero,
                        constraints: const BoxConstraints(minWidth: 36, minHeight: 36),
                        icon: const Icon(Icons.settings_outlined, color: Color(0xFF666666), size: 20),
